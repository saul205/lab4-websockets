...
public class ElizaServerTest {
	...
	public void onChat() throws DeploymentException, IOException, URISyntaxException, InterruptedException {
        ...
        // mandar mensaje
        session.getAsyncRemote().sendText("Hola");
        Thread.sleep(100);
        ...
        // check pregunta
        // Se esperan 5 mensajes, 3 al inicio y 2 de la respuesta
        // La respuesta esperada es "This is quite interesting." seguido de un "---"
